            ...
            <div className='container'>
                ...
                <div className='row mt-3'>
                    ...
                    <div className='col-3 text-center'>
                        ...
                        <select className="form-control" name="cinsiyet" value={staff.cinsiyet || ''} onChange={handleStaffChange}>
                ...
                <div className='row mt-4'>
                    ...
                    <div className='col-3 text-center'>
                        ...
                        <select className="form-control" name="mezuniyetDurumu" value={staff.mezuniyetDurumu || ''} onChange={handleStaffChange}>
                ...
                <div className='row mt-4'>
                    <div className='col-3 text-center'>
                        <label>Birim:</label>
                        <select className="form-control" name="birim" value={staff.birim || ''} onChange={handleStaffChange}>
                    ...
                    <div className='col-3 text-center'>
                        <label>Görev:</label>
                        <select className="form-control" name="gorev" value={staff.gorev || ''} onChange={handleStaffChange}>
